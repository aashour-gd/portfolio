...
const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    title: "A Design System for Two Products",
    category: "Design Systems · Front-end",
    hook: "One token set, two products — consistent without being frozen.",
    summary:
      "44 shared components, 75 theme tokens per mode, and per-product branding derived from a single token set — the written conventions that keep two products consistent.",
    tags: ["Design Systems", "Design Tokens", "Theming"],
    accent: "#6366F1",
    panelBg: "#12142B",
    imageSrc: "/images/nexa-design-system-cover.png",
    href: "/case-studies/design-system-two-products",
    stats: [
      { value: "44", label: "Components" },
      { value: "75", label: "Tokens/mode" },
